...
| Field | Meaning |
|------|------|
| mode | SOCD mode value: `0` later-input priority, `1` absolute priority (keyName), `2` absolute priority (keyName2), `3` neutral/cancel, `4` depth priority |
...
| mode | number \| string | SOCD mode, supports `0/1/2/3/4` or `socdLaterInputPriority/socdAbsolutePriority/socdAbsolutePriority2/socdNeutral/socdCancel/socdDepthPriority` | Yes |
